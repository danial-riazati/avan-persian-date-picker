...
automatically by `@avan/react` calendars, or standalone in any project that needs Iran holiday
data.

## Install

```bash
pnpm add @avan/holidays
```
...
```ts
import holidays1405 from '@avan/holidays/1405';
```
