...
2. Update every `@avan/*` package together (`pnpm up "@avan/*"`) — packages in this monorepo are
...
Avan's internal source paths directly (unsupported) — the public `@avan/react`/`@avan/react/client`
